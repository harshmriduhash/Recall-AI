...
CREATE TABLE public.memories (
  ...
  type TEXT NOT NULL DEFAULT 'note' CHECK (type IN ('note', 'code', 'decision', 'conversation')),
  memory_layer TEXT NOT NULL DEFAULT 'working' CHECK (memory_layer IN ('working', 'episodic', 'semantic')),
  tags TEXT[] DEFAULT '{}',
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  updated_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()
);
