  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-in-bottom": { from: { opacity: "0", transform: "translateY(24px)" }, to: { opacity: "1", transform: "translateY(0)" } },
        "scale-in": { from: { opacity: "0", transform: "scale(0.9)" }, to: { opacity: "1", transform: "scale(1)" } },
        pulse: { "0%, 100%": { opacity: "1" }, "50%": { opacity: "0.5" } },
        shimmer: { "0%": { backgroundPosition: "-200% 0" }, "100%": { backgroundPosition: "200% 0" } },
        "spin-slow": { from: { transform: "rotate(0deg)" }, to: { transform: "rotate(360deg)" } },
        float: { "0%, 100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-12px)" } },
        orbit: { from: { transform: "rotate(0deg) translateX(24px) rotate(0deg)" }, to: { transform: "rotate(360deg) translateX(24px) rotate(-360deg)" } },
        "orbit-reverse": { from: { transform: "rotate(0deg) translateX(18px) rotate(0deg)" }, to: { transform: "rotate(-360deg) translateX(18px) rotate(360deg)" } },
      ...
      animation: {
        ...
        "orbit-reverse": "orbit-reverse 2.5s linear infinite",
